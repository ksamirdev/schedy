---
title: "Install & Run"
description: "Run Schedy with Docker, a prebuilt binary, on Kubernetes, or build it from source."
---
...
Data persists to the `data/` directory (BadgerDB), so tasks survive restarts. Back it up to preserve scheduled work.
